...
for i = 1 : length(list)
   ...
   datacube = smooth3(datacube,'gaussian',[9 9 9],1);
   ...
   figurename = ['./temp/example',num2str(i), '_Smooth_noiselevel'];
   hgsave(h, figurename);
   ldpXname = ['./temp/example',num2str(i), '_Smooth_ldpX',  '.mat'];
   save(ldpXname, 'ldpDataX');
   ldpYname = ['./temp/example',num2str(i), '_Smooth_ldpY',  '.mat'];
   save(ldpYname, 'ldpDataY');
   ldpZname = ['./temp/example',num2str(i), '_Smooth_ldpZ',  '.mat'];
